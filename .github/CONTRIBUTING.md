...
2. Read `skills/zr-github-defaults/SKILL.md` for repository-specific guidance.
...
2. `CONTRIBUTING.md`
3. `skills/zr-github-defaults/SKILL.md`
...
- Run the required repository checks listed in `skills/zr-github-defaults/SKILL.md` before opening or updating a PR.
